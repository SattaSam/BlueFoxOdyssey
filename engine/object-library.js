(function (global) {
  ...
  const PRODUCTION_SPECS = Object.freeze([
    ...
    { id: "DOC-BIO-FLUV-S-001", type: "fluorescent_vegetation", label: "Végétation fluorescente", category: "flora", subtype: "fluorescent_ground_vegetation", size: "S", rarity: "common", biomes: ["forest", "jungle", "swamp", "alien"], scenes: ["Sous-bois fluorescent", "Rive lumineuse"], states: ["dormante", "lumineuse", "inspectée", "récoltée", "repousse"], actions: ["observe", "inspect", "collect", "analyze"], defaultAction: "inspect", acquisitionAction: "collect", requiresInspectionBeforeCollect: true, afterInspectionAction: "collect", collectable: true, inspectable: true, respawn: 120, inventoryKey: "fluorescent_biomass", exploitability: "harvestable", family: "flora", resourceFamily: "biomass", research: ["botany", "bioluminescence", "energy"], tags: ["resource", "plant", "glowing", "ground_cover"], spawnCost: 1, maxPerZone: 12, minDistance: 0.8, maxSlope: 30, radius: 0.5, volume: "small", curiosity: 0.55, harvest: 0.35, decision: "validated" },
    ...
    { id: "TEC-PRIS-S-001", type: "logic_prism", label: "Prisme logique pyramidal", category: "components", subtype: "pyramidal_luminous_component", size: "S", rarity: "rare", biomes: ["ruins", "crystalline", "magnetic", "alien"], scenes: ["Nœud logique", "Sanctuaire technologique"], states: ["détruit", "dégradé", "usé", "intact"], actions: ["observe", "inspect", "analyze", "collect"], defaultAction: "inspect", acquisitionAction: "collect", requiresInspectionBeforeCollect: true, afterInspectionAction: "collect", collectable: true, inspectable: true, respawn: 5400, inventoryKey: "logic_prism", exploitability: "rare-salvage", family: "technology", resourceFamily: "component", research: ["computing", "engineering", "logic"], tags: ["technology", "component", "rare", "glowing", "pyramidal"], spawnCost: 7, maxPerZone: 1, minDistance: 10, maxSlope: 20, radius: 0.52, volume: "small", curiosity: 1, harvest: 0.72, decision: "new" },
