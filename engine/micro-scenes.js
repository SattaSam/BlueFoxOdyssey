(function (global) {
  ...
  const BUILTIN_TEMPLATES = Object.freeze({
    ...
    deployed_beacon: Object.freeze({ id: "MSC-DEPLOYED-BEACON-001", biomes: Object.freeze(["all"]), rarity: "constructed", missionOnly: true, radius: 2.5, objects: Object.freeze([Object.freeze({ type: "survey_beacon", offset: [0,0,0], variant: 0 })]) }),
